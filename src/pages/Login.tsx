    ...
    <div className="min-h-screen flex items-center justify-center p-8">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-muted/50 border border-border rounded-lg p-3 mb-6">
          ...
          <p className="text-xs text-foreground font-mono">demo@digilock.com / demo123</p>
          <p className="text-xs text-muted-foreground mt-1">or use username: demo_user</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button className="w-full" type="submit" disabled={isLoading}>
            ...
            {!isLoading && <ArrowRight className="w-4 h-4 ml-1" strokeWidth={1.5} />}
          </Button>
        </form>
